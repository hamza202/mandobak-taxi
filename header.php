                                                ...
                                                <ul class="m-nav m-nav--skin-light">
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="#" class="m-nav__link">
                                                                <span class="m-nav__link-icon"><img
                                                                        class="m-topbar__language-img"
                                                                        src="assets/app/media/img/flags/008-saudi-arabia.svg"></span>
                                                            <span class="m-nav__link-title m-topbar__language-text m-nav__link-text">Arabic</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                                ...
                                                <ul class="m-nav m-nav--skin-light">
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="header/profile.html" class="m-nav__link">
                                                            ...
                                                            <span class="m-nav__link-text"> My Balance</span>
                                                        </a>
                                                    </li>
                                                    <li class="m-nav__item">
                                                        <a href="header/profile.html" class="m-nav__link">
